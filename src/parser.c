...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [277] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_triple_single_quoted_string_literall, 2),
  [279] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_triple_single_quoted_string_literall, 2),
  ...
  [383] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_triple_single_quoted_string_literall, 3),
  [385] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_triple_single_quoted_string_literall, 3),
  ...
  [442] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_triple_single_quoted_string_literall_repeat1, 2), SHIFT_REPEAT(101),
  [445] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_triple_single_quoted_string_literall_repeat1, 2),
